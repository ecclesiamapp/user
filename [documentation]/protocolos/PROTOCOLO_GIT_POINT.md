# 🛡️ Protocolo Git Point - Ecclesiam App
...
* **Nome padrão da Tag**: `restore-point-YYYYMMDD-HHMMSS` (substituindo pela data/hora local atual, ex: `restore-point-20260924-002500`).
* **Comando**:
  ```bash
  git tag -a restore-point-YYYYMMDD-HHMMSS -m "Ponto de restauração Ecclesiam App antes de novas alterações"
  ```
