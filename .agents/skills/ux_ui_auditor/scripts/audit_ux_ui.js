...
const REPLACEMENTS = [
  // 1. Substituir bg-white por bg-[var(--dash-surface)] quando for classe tailwind avulsa de contêiner
  {
  ...
  // 3. Substituir arredondamentos ríspidos por cantos modernos
  {
    regex: /(?<![a-zA-Z0-9-])rounded-\[(?:3[0-9]|4[0-9]|5[0-9])px\](?![a-zA-Z0-9-])/g,
    replace: 'rounded-2xl',
    desc: "Padronizando arredondamentos customizados extremos para rounded-2xl"
  }
];

// Procurar arquivos recursivamente
...
console.log("==========================================");
console.log("🛡️   INICIANDO AUDITORIA UX/UI (Ecclesiam App)");
console.log("==========================================\n");
